    ...
    <div class="leftpanelinner">
        ...
        <div class="media leftpanel-profile">
            ...
            <div class="media-body">
                <h4 class="media-heading">ShopOwner <a data-toggle="collapse" data-target="#loguserinfo" class="pull-right"><i class="fa fa-angle-down"></i></a></h4>
        ...
        <ul class="nav nav-tabs nav-justified nav-sidebar">
            ...
            <li class="tooltips" data-toggle="tooltip" title="Log Out"><a href="../common/"><i class="fa fa-sign-out"></i></a></li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="mainmenu">
                ...
                <ul class="nav nav-pills nav-stacked nav-quirk">
                    <li><a href="shopowner"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
